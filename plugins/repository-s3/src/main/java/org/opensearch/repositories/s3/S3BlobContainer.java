...
class S3BlobContainer extends AbstractBlobContainer implements AsyncMultiStreamBlobContainer {
    ...
    public InputStream readBlobVersion(String blobName, String versionId) throws IOException {
        ...
        try (AmazonS3Reference clientReference = blobStore.clientReference()) {
            ...
            ResponseInputStream<GetObjectResponse> s3ObjectStream = SocketAccess.doPrivileged(
                () -> clientReference.get().getObject(getRequest)
            );
    ...
    public void executeMultipartUploadConditionally(
        ...
        configureEncryptionSettings(createRequestBuilder, blobStore);
